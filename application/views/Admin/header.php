  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url()?>index.php/admin">
        ...
        <div class="sidebar-brand-text mx-3">Digital<sup>Printing</sup></div>
      </a>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="#">
                  ...
                  Settings - <?= $this->session->userdata("role"); ?>
                </a>
                <a class="dropdown-item" href="#">
                ...
                <a class="dropdown-item" href="<?= base_url('index.php/konsumen/logout') ?>" data-toggle="modal" data-target="#logoutModal">
